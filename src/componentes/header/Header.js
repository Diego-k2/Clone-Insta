...
function Header(){
    return(
        ...
        <div>
            ...
            <button className="text__button"><img src="https://img.icons8.com/external-kiranshastry-lineal-kiranshastry/24/000000/external-user-interface-kiranshastry-lineal-kiranshastry.png"/></button>
            </div>
